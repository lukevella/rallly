...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "overflow-hidden rounded-2xl border-x border-y bg-card text-card-foreground shadow-2xs",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn("flex items-center gap-x-2.5 font-medium text-sm", className)}
    {...props}
  />
));
