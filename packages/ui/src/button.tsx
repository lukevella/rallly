...
const buttonVariants = cva(
  ...
  ),
  {
    variants: {
      variant: {
        primary:
          "border-primary-700 shadow-sm bg-primary disabled:bg-gray-400 disabled:border-transparent text-primary-foreground shadow-sm hover:bg-primary-500 focus:bg-primary-400",
        destructive:
        ...
        default:
          "px-3.5 py-2.5 data-[state=open]:shadow-none data-[state=open]:bg-gray-100 focus:border-gray-300 focus:bg-gray-200 hover:bg-gray-100 bg-gray-50",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80",
        ghost:
          "border-transparent bg-transparent hover:bg-gray-200 focus:border-gray-300 focus:bg-gray-200",
        link: "underline-offset-4 border-transparent hover:underline text-primary",
      },
      size: {
        default: "h-9 px-2.5 gap-x-2.5 text-sm rounded-md",
