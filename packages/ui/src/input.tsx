...
function Input({
  ...
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        "w-full min-w-0 border border-input bg-background/80 transition-[color,box-shadow] selection:bg-primary selection:text-primary-foreground file:inline-flex file:h-7 file:border-0 file:bg-transparent file:font-medium file:text-foreground file:text-sm placeholder:text-muted-foreground disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 dark:bg-foreground/5",
