...
export function RegisterOTPForm({ email }: { email: string }) {
  ...
  const handleSubmit = form.handleSubmit(async (data) => {
    // Creates an account if the email is new, otherwise signs into the
    // existing one. A guest session is linked to the account either way.
    ...
    if (res.error) {
      posthog?.capture("register:otp_verify_error", {
    ...
    // A newly created account has no name yet; send it through onboarding
