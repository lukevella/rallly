  ...
  return (
    <div className="flex flex-col items-center gap-4 py-6 text-center text-muted-foreground text-sm">
      ...
      {isAttributionHidden ? null : (
        <Link
          className="inline-flex h-9 items-center gap-2 rounded-full border border-border bg-muted px-4 font-normal text-foreground text-sm shadow-xs transition-[background-color,transform] ease-out hover:bg-muted-border active:scale-[.98] motion-reduce:active:scale-100"
