...
const defaultValues = {
  ...
  maxAttendees: "",
  description: "",
  locationType: "" as "" | "in_person" | "custom_link",
  locationAddress: "",
  locationUrl: "",
  locationText: "",
};
                ...
                render={({ field }) => (
                  <FormItem>
                    <div className="flex items-center justify-between">
                      <FormLabel>
                        <Trans
                          i18nKey="maxAttendees"
                          defaults="Max attendees"
                        />
                      </FormLabel>
                      <RemoveOptionalButton
                        onClick={handleRemoveMaxAttendees}
                      />
                    </div>
                    <FormControl>
