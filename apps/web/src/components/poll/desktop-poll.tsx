            ...
            {participants.length > 0 || mode !== "view" ? (
              <div className="relative flex min-h-0 flex-col">
                ...
                <RemoveScroll
                  ...
                  ref={scrollRef}
                  className={cn(
                    "scrollbar-thin hover:scrollbar-thumb-gray-400 scrollbar-thumb-gray-300 scrollbar-track-gray-100 relative z-10 w-full flex-grow overflow-auto scroll-smooth",
                  )}
                >
                  <table className="table-auto border-separate border-spacing-0 bg-gray-50  ">
                    <thead>
                      <PollHeader />
                    </thead>
                    <tbody>
