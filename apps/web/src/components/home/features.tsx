...
const Features: React.FunctionComponent = () => {
  ...
  return (
    <div className="mx-auto max-w-7xl py-16 px-8">
      <h2 className="heading">{t("homepage.features")}</h2>
      <p className="subheading">{t("homepage.featuresSubheading")}</p>
      <div className="grid grid-cols-2 gap-12">
        <div className="col-span-2 md:col-span-1">
          ...
          <p className="text">{t("homepage.timeSlotsDescription")}</p>
        </div>
        <div className="col-span-2 md:col-span-1">
          <div className="mb-4 inline-block rounded-2xl bg-cyan-100/50 p-3 text-cyan-500">
            <DeviceMobileIcon className="h-8 w-8" />
          </div>
          <h3 className="heading-sm">{t("homepage.mobileFriendly")}</h3>
          <p className="text">{t("homepage.mobileFriendlyDescription")}</p>
        </div>
        <div className="col-span-2 md:col-span-1">
          <div className="mb-4 inline-block rounded-2xl bg-rose-100/50 p-3 text-rose-500">
            <BellIcon className="h-8 w-8" />
          </div>
          <h3 className="heading-sm">{t("homepage.notifications")}</h3>
          <p className="text">{t("homepage.notificationsDescription")}</p>
        </div>
        <div className="col-span-2 md:col-span-1">
          <div className="mb-4 inline-block rounded-2xl bg-yellow-100/50 p-3 text-yellow-500">
            <ChatIcon className="h-8 w-8" />
          </div>
          <h3 className="heading-sm">{t("homepage.comments")}</h3>
          <p className="text">{t("homepage.commentsDescription")}</p>
        </div>
      </div>
    </div>
  );
