      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild={true}>
          <button
            ...
            className="flex h-10 w-full items-center justify-between rounded border bg-white px-3 py-2 text-sm hover:bg-gray-50 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
          >
            {value ? (
