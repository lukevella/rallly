      ...
      {!poll.event ? (
        <CardFooter>
          {isWriting ? (
            ...
            <button
              type="button"
              className="flex w-full rounded-lg border border-input bg-transparent px-2 py-2 text-left text-muted-foreground text-sm focus-visible:ring-2 focus-visible:ring-offset-1"
