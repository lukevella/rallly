...
// Sort alphabetically by city (runtime will re-sort by offset)
...
const other = entries.filter((e) => !e.curated);

const curatedTs = curated.map(entryToTs).join(",\n");
const otherTs = other.map(entryToTs).join(",\n");
