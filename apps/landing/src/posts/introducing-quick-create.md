...
One of the things that sets Rallly apart from other scheduling tools is its ability to create meeting polls without the need to sign up for an account. As Rallly has grown and added more powerful features, I wanted to make sure new users could still get started quickly while having a clear path to discovering everything Rallly has to offer.

The previous approach of giving full platform access to non-logged in users had some limitations:
