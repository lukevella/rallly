...
Roles control what someone can manage in a space:
...
<CardGroup cols={2}>
  ...
  <Card title="Member" icon="user">
    **Scheduling**
    - Creates and manages their own polls and events
  </Card>
</CardGroup>

<Info>
Roles do not control who can see whose polls and events — that is decided by
the space's [collaboration setting](/spaces/collaboration), which applies to
every role equally.
</Info>
