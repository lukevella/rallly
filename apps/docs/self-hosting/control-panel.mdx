...
The Control Panel home page shows the version your instance is running and whether a newer release is available. The check runs against `api.rallly.co` once an hour and only sends the running version and an anonymous instance identifier.
