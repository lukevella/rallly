...
<ParamField path="OIDC_NAME_CLAIM_PATH" default="name">
  The path to the OIDC claim where the user's name can be found
</ParamField>

<ParamField path="OIDC_EMAIL_CLAIM_PATH" default="email">
  The path to the OIDC claim where the user's email can be found.
</ParamField>

<ParamField path="OIDC_PICTURE_CLAIM_PATH" default="picture">
  The path to the OIDC claim where the user's profile picture can be found.
</ParamField>
