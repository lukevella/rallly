...
<Note>
  Internal wiring (database URL, S3 endpoint, `NEXT_PUBLIC_BASE_URL`) is handled by the Compose stack and derived from the values below. You do not need to set them yourself.
</Note>
