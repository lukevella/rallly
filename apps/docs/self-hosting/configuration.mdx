...
<ParamField path="PRIVACY_POLICY_URL">
  URL of your privacy policy. When set, a link is shown in the footer of
  public pages such as the create poll page.
</ParamField>

<ParamField path="TERMS_OF_USE_URL">
  URL of your terms of use. When set, a link is shown in the footer of
  public pages such as the create poll page.
</ParamField>
