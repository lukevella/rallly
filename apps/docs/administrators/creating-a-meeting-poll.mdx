...
To create a meeting poll, start by going to the [New Event Poll Page](https://rallly.co/new).
...
<Frame>![](/images/meeting-poll/new_event_page.png)</Frame>
...
<Frame>![](/images/meeting-poll/calender.png)</Frame>

Now, you can click **Create poll** to create the poll.
