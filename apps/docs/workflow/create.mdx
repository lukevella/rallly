...
<Steps>
  ...
  <Step title="Select dates or times">
    ...
    **Vote options** - Participants can answer **Yes**, **If need be** or **No**.
    Change this to **Yes** and **No** under **Settings** if you'd rather not
    offer a maybe.
  ...
  <Step title="Create your poll">
    ...
    <Frame>
      <img src="/images/workflow/poll-created.png" alt="Share dialog shown after creating a poll"/>
    </Frame>
