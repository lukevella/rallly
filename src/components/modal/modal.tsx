  ...
  return visible ? (
    ...
    >
      ...
      >
        ...
        />
        <div className="relative z-50 my-8 inline-block max-w-full transform animate-popIn text-left align-middle">
          <div className="mx-4 max-w-full overflow-hidden rounded-md bg-white shadow-xl xs:rounded-xl">
            {showClose ? (
              <button
